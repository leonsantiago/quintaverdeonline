<div id="promotions" class="col-11 col-md-2 align-middle text-shadow product" >
  ...
  <div class="row">
      ...
      <div class="btn-group col-10 mx-auto justify-content-around text-center" role="group">
          <div class="col-3"id="decrease" onclick="promotionValue('{{ $promotion_index }}_decrease')" value="Decrease Value">
          ...
          <div class="col-3" id="increase" onclick="promotionValue('{{ $promotion_index }}_increase')" value="Increase Value">
